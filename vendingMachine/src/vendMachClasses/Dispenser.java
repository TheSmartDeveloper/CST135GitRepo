...
public class Dispenser
{
	...
	public int dispenseItem(int i, int j)								//method to dispense items, will set a certain row to 0 since a row cannot have more than one item because this is a vertical 2d machine not a 3d machine
	{
		return columnArray[i][j] = 0;
	}
	public int loadMachine(int i, int j)								//method to ad items, will set a certain row to 1 since a row cannot have more than one item because this is a vertical 2d machine not a 3d machine
	{
		return columnArray[i][j] = 1;
	}
